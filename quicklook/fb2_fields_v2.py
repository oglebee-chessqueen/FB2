...
## MAJOR CHANGE:
##
#  - read in TXT file, rather than FITS file
#
...
while not(quit):
	...
	#Get filename for this image
	filename = "%s%06i.fits.txt" % (filename_root,num)
	...
	if not filefound:
		...
		log(logfile,"FITS/TXT file not created/found yet.; Sleeping... %2i seconds" % (delay))
		time.sleep(delay)
